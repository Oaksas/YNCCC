  ...
  $.fn[pluginName] = function (options) {
    ...
    var pagination = {
      ...
      generateHTML: function (args) {
        ...
        var formatNavigator = $.isFunction(attributes.formatNavigator)
          ? attributes.formatNavigator(currentPage, totalPage, totalNumber)
          : attributes.formatNavigator;
        var formatGoInput = $.isFunction(attributes.formatGoInput)
          ...
          : attributes.formatGoInput;
        var formatGoButton = $.isFunction(attributes.formatGoButton)
        ...
        var autoHidePrevious = $.isFunction(attributes.autoHidePrevious)
          ? attributes.autoHidePrevious()
          : attributes.autoHidePrevious;
        var autoHideNext = $.isFunction(attributes.autoHideNext)
          ? attributes.autoHideNext()
          : attributes.autoHideNext;

        var header = $.isFunction(attributes.header)
          ? attributes.header(currentPage, totalPage, totalNumber)
          : attributes.header;
        var footer = $.isFunction(attributes.footer)
      ...
      go: function (number, callback) {
        ...
        postData[
          alias.pageNumber ? alias.pageNumber : 'pageNumber'
        ] = pageNumber;

        var ajaxParams = $.isFunction(attributes.ajax)
          ? attributes.ajax()
          : attributes.ajax;
      ...
      parseDataSource: function (dataSource, callback) {
        ...
        if (Helpers.isObject(dataSource)) {
          callback(
            (attributes.dataSource = self.filterDataByLocator(dataSource))
          );
